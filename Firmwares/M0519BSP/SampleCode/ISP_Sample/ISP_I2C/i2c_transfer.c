...
void I2C_Init(void)
{
    ...
    u32BusClock = 100000;
    I2C0->I2CLK = (uint32_t)(((SystemCoreClock * 10) / (u32BusClock * 4) + 5) / 10 - 1); /* Compute proper divider for I2C0 clock */
    /* Set I2C0 Slave Addresses */
    I2C0->I2CADDR0 = (I2C0->I2CADDR0 & ~I2C_I2CADDR_I2CADDR_Msk) | (g_u8DeviceAddr << I2C_I2CADDR_I2CADDR_Pos);
